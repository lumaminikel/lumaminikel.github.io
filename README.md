...
-   **Projetos:** Uma galeria com alguns dos meus principais projetos, com links para visualização e para os repositórios.
...
-   **Botão de Contato Flutuante:** Um botão do WhatsApp sempre visível para facilitar o contato.

## Tecnologias Utilizadas

-   **HTML5:** Para a estrutura semântica do site.
-   **CSS3:** Para a estilização, utilizando Flexbox e Grid Layout para um design moderno e responsivo.
-   **JavaScript:** Para a interatividade do site, como o menu de navegação dinâmico e o menu hambúrguer.
...
Para visualizar o site, basta abrir o arquivo `index.html` ou acessar o link: https://lumaminikel.github.io em seu navegador de preferência.
